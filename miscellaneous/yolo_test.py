...
def real_time_test(path):
    ...
    # ask blip2_endpoint_call for a response that includes all of the objects in an image
    ...
    # now we will pass the following into blip2_endpoint_call
...
# then we can later pass each of these images into blip2_endpoint_call
